...
ALLOWED_HOSTS = ['woleabrahamthedev.pythonanywhere.com', '127.0.0.1', 'django-inventory-et7j.onrender.com', "69.62.122.230", "store.datatodecisions.org"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'inventory.context_processors.is_admin',
            ],
        },
    },
]
...
# settings.py
LOGIN_REDIRECT_URL = '/dashboard/'  # Redirect to a dashboard after login
